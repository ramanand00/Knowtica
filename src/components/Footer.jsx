            ...
            <div className="container copyright">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; <a href="#">Knowtica</a> | 2024, All Right Reserved.</p>
                    </div>
                    <div className="col-md-6">
                        <p>Designed By <a href="https://www.facebook.com/profile.php?id=100058685671028">Knowtica, Rajbiraj, Nepal</a></p>
                    </div>
                </div>
            </div>
        </ div>
