...
function Admin() {
    ...
    const adminLogin = async () => {
        MySwal.fire({
            ...
            preConfirm: async () => {
                try {
                    const url = `https://the-Knowtica-ngo-server.onrender.com/api/v1/registration/auth`;
    ...
    const fetchLearnings = async (auth1) => {
        var options = {
            method: 'GET',
            url: 'https://the-Knowtica-ngo-server.onrender.com/api/v1/search/allLearnings',
            headers: {
    ...
    const fetchUserInfo = async (mail) => {
        var options = {
            method: 'GET',
            url: 'https://the-Knowtica-ngo-server.onrender.com/api/v1/search/Learnings?email=' + mail,
            headers: {
    ...
    const search = async () => {
        ...
        var options = {
            method: 'GET',
            url: 'https://the-Knowtica-ngo-server.onrender.com/api/v1/search/' + query,
            headers: {
                Authorization: `Basic ${auth}`,
                'Content-Type': 'application/json'
            },
                                ...
                                <div className="popupContent" id="myPopup">
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            <h1 className="text-center text-warning p-3 bg-dark rounded-top-4">Knowtica</h1>
